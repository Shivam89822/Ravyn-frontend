...
const dislikeComment = async (commentId) => {
  ...
  return (
   <div className="comment-backdrop">
    <div className="comment-overlay-comment">
      {/* LEFT : IMAGE PREVIEW */}
      <div className="comment-left">
        {post.type === "image" && (
           ...
           {post.type === "video" && (
            <div className="video-preview" onClick={toggleVideo}>
      ...
      <div className="comment-right">
        ...
        <div className="comment-header">
          <div className="user-info">
            <div className="avatar">{post?.userId?.profilePictureUrl&&<img style={{}} src={post?.userId?.profilePictureUrl} alt="" />}</div>
            <div>
              <div className="username">{post?.userId?.userName}</div>
              <div className="location">California, USA</div>
            </div>
          </div>
          <div className="close-btn" onClick={()=>{setPost(null)}}>✕</div>
        </div>
